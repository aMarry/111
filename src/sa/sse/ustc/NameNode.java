...
// NameNode 准备使用单例模式，这里不考虑双备份，只运行一个NameNode
public class NameNode {
	...
	private List<Client> dataNodes = new ArrayList<Client>(); // 维护DataNode的一个集合
	...
	//2. 需要对每个已连接的DataNode设置定时器，如果规定时间内未收到HeartBeat，则认为该DataNode死亡,还未实现
